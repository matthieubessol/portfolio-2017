      ...
      <div className={classes}>
        ...
        <div className="about__right">
          <div className="about__content">
            ...
            <p>I believe <span>motion</span> leads to logic and that <span>performance</span> is a feature, not a bonus.</p>
            ...
            <p className="small-top">or contact me with my mail <a href="mailto:matthieubessol@gmail.com"><span>matthieubessol@gmail.com</span></a></p>
          </div>
        </div>
      </div>
    );
