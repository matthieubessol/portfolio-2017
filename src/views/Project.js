...
class Project extends Component {
  ...
  componentDidMount() {
    if (window.innerWidth >= 768) {
      document
        .getElementsByClassName("header__left")[0]
    ...
    if (document.getElementsByClassName("product__header")[0]) {
      if (this.refs.header)
        this.refs.header.style.transform =
          "translateY(" + scrolled / 4 + "px) translateZ(0)";
      if (this.refs.title)
        this.refs.title.style.transform =
          "translate3d(-50%,calc(-50% + -" + scrolled / 2 + "px),0)";
    }
    if (
      scrolled >
      document.getElementsByClassName("product__header")[0].offsetHeight
    )
      document
        .getElementsByClassName("header__left")[0]
    ...
    return (
      <div className="product" ref="product">
        ...
        <div className="product__header" ref="header">
          ...
          <div className="product__cover" style={divStyle}></div>
          <div className="overflow">
            <div className="product__title" ref="title">
          ...
          <Scroll
            ...
            handleScrollClick={this.handleScrollClick.bind(this)}
          />
        </div>
        <div className="product__content" ref="productContent">
          ...
          <NextProject
            getCorrect={this.getCorrectNext.bind(this)}
            data={data.project}
            id={this.state.id}
          />
        </div>
